...
export default function Home() {
  const fullName = process.env.NEXT_PUBLIC_FULL_NAME || '{{FULL_NAME}}'
  const siteType = process.env.NEXT_PUBLIC_SITE_TYPE || '{{SITE_TYPE}}'
      ...
      <header className="border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-semibold">{siteType}</span>
          </div>
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Your personalized {siteType} experience awaits. 
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Optimized performance for the best {siteType} experience
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Crafted specifically for {fullName} with modern aesthetics
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Join thousands of users who trust {siteType} for their needs.
          </p>
          <Button size="lg" className="gap-2">
            Start Your Journey
            <ArrowRight className="w-4 h-4" />
      ...
      <footer className="border-t mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-sm text-muted-foreground">
            © 2024 {siteType}. Built with ❤️ for {fullName}
          </div>
        </div>
      </footer>
    </div>
